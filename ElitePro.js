  ...
  EliteProEmpire.sendMessage(m.chat, {
    ...
    contextInfo: {
      externalAdReply: {
        ...
        sourceUrl: global.link, // Replace with your channel link
        mediaType: 1,
...
case 'play': case "ytmp3": {
  ...
  try {
    ...
    const body = `*ELITE-PRO-V1_MUSIC - PLAYER*\n` +
      `> *Title:* ${video.title}\n` +
      `> *Views:* ${video.views}\n` +
...
`.trim()
  ...
  await EliteProEmpire.sendMessage(m.chat, { react: { text: "☑️",key: m.key,}})
                EliteProEmpire.sendMessage(m.chat, {
                    text: `
*╭───❍* *ELITEPRO REPO INFO* *❍* 
*┊* Bot script is now available on GitHub 
*┊* *REPOSITORY: ELITEPRO* 👨🏼‍💻 URL:
*┊* https://github.com/elite-md/ElitePro
*╰═════════════❍*
> *Updated 30/01/2025 06:40:33*`,
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `${botname}`,
